...
public class Pizza {
    ...
    private String id, Name, Recipe,  eighteen_price,  twenty_four_price,  thirty_price, eighteen_weight,  twenty_four_weight,  thirty_weight;
    private int Picture;

    public Pizza() {}

    public Pizza(String id, String name, String recipe, int picture, String eighteen_price, String twenty_four_price, String thirty_price, String eighteen_weight, String twenty_four_weight, String thirty_weight) {
        this.id = id;
        Name = name;
        Recipe = recipe;
